...
class Window(Tk):
    def __init__(self):
        ...
        self.title("Python PDF to Audio and Audio to PDF converter")
        self.geometry('400x250')
        self.resizable(0, 0)
        self.config(bg='Burlywood')

        Label(self, text='Python PDF to Audio and Audio to PDF converter', wraplength=400,
              bg='Burlywood', font=("Courier", 15)).place(x=0, y=0)

        Button(self, text="Convert PDF to Audio", font=("Courier", 15), bg='light blue',
               command=self.pdf_to_audio, width=25).place(x=40, y=80)

        Button(self, text="Convert Audio to PDF", font=("Courier", 15), bg='light blue',
    ...
    def pdf_to_audio(self):
        ...
        Label(pta, text='Convert PDF to Audio', font=('Courier', 15), bg='Chocolate').place(relx=0.3, y=0)
    ...
    def audio_to_pdf(self):
        ...
        Label(atp, text='Convert Audio to PDF', font=("Courier", 15), bg='FireBrick').place(relx=0.36, y=0)
